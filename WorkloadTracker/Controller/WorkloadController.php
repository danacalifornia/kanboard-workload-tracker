...
namespace Kanboard\Plugin\WorkloadTracker\Controller;
...
class WorkloadController extends BaseController
{
    ...
    {
        // Get workload data directly in controller
        $workloadData = $this->getTeamWorkload();
        
        $this->response->html($this->helper->layout->app('WorkloadTracker:workload/index', array(
            'title' => 'Team Workload',
            'workload_data' => $workloadData
        )));
    }
    
    private function getTeamWorkload()
    {
